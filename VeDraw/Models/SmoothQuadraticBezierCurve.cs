...
{
    public class SmoothQuadraticBezierCurve : Token
    {
        /// <summary>
        /// Initializes a new instance of <see cref="SmoothQuadraticBezierCurve"/> class.
        /// </summary>
        public SmoothQuadraticBezierCurve()
        {
            X1 = 0.0;
            Y1 = 0.0;
            X2 = 0.0;
        ...
        public SmoothQuadraticBezierCurve(double x1, double y1, double x2, double y2)
        {
            X1 = x1;
            Y1 = y1;
            X2 = x2;
        ...
        /// which determines the starting tangent of the curve.
        /// </summary>
        ...
        public static SmoothQuadraticBezierCurve Parse(string markup, out int s, out int e)
        {
            // Let Regex get the X and the Y values.
            var match = Regex.Match(markup,
                @"(T|t)\s*" + @"(\d+\.\d+|\d+)(\s|\,)(\d+\.\d+|\d+)" +  // Lexeme + space + first control point.
            ...
            return new SmoothQuadraticBezierCurve(x1, y1, x2, y2);
        }

        public override string ToString() => $"T {X1} {Y1} {X2} {Y2}";
    }
}
